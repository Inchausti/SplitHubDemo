...
window.SH_TABLES = {
  ...
  pagamentos: {
    ...
    cols: [
      ...
      { label: 'Origem' },
      { label: 'Nº da guia' },
      { thHtml: '<span style="display:inline-flex;align-items:center;gap:5px">Entrega<span style="position:relative;display:inline-flex" class="ctr-tip-wrap"><span style="width:14px;height:14px;border-radius:50%;background:rgba(var(--teal-alt-rgb),.15);border:1px solid rgba(var(--teal-alt-rgb),.35);display:inline-flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;color:var(--teal);cursor:default;line-height:1;flex-shrink:0">?</span><span class="ctr-tip" style="display:none;position:absolute;right:0;top:22px;width:320px;background:var(--sidebar);border:1px solid var(--border);border-radius:8px;padding:14px 16px;z-index:9900;box-shadow:0 8px 24px rgba(0,0,0,.28);pointer-events:none;font-weight:400;text-transform:none;letter-spacing:0"><div style="font-size:11px;font-weight:700;color:var(--txt1);margin-bottom:8px">Entrega da guia ao ERP</div><div style="font-size:11px;color:var(--txt2);line-height:1.6">Estado do webhook <code>rad.darf_recebida</code>, que leva a guia gerada ao ERP. <strong>Entregue</strong> — o ERP respondeu <code>200 OK</code>. <strong>Pendente</strong> — em retentativa. <strong>Falha</strong> — as tentativas se esgotaram e o ERP não recebeu; a guia existe aqui e não existe lá.<br><br>O reenvio fica em Configurações &rarr; Integrações &rarr; Log de entregas.</div></span></span></span>' },
      { thHtml: '<span style="display:inline-flex;align-items:center;gap:5px">RFB<span style="position:relative;display:inline-flex" class="ctr-tip-wrap"><span style="width:14px;height:14px;border-radius:50%;background:rgba(var(--teal-alt-rgb),.15);border:1px solid rgba(var(--teal-alt-rgb),.35);display:inline-flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;color:var(--teal);cursor:default;line-height:1;flex-shrink:0">?</span><span class="ctr-tip" style="display:none;position:absolute;right:0;top:22px;width:320px;background:var(--sidebar);border:1px solid var(--border);border-radius:8px;padding:14px 16px;z-index:9900;box-shadow:0 8px 24px rgba(0,0,0,.28);pointer-events:none;font-weight:400;text-transform:none;letter-spacing:0"><div style="font-size:11px;font-weight:700;color:var(--txt1);margin-bottom:8px">Rastreamento na Receita Federal</div><div style="font-size:11px;color:var(--txt2);line-height:1.6">Vem do campo <code>rastreamento_rfb</code> do comprovante que o ERP registra em <code>POST /v1/rad/proofs</code>: protocolo do pagamento, <code>status_rdoc</code> e data de confirmação. <strong>Confirmado</strong> — a Receita reconheceu o recolhimento. <strong>Processando</strong> — pago, mas ainda sem confirmação.<br><br>É o último elo: sem ele, o pagamento existe no banco e não no Fisco.</div></span></span></span>' },
